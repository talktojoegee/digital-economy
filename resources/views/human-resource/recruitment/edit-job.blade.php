        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('update-job')}}" method="post" autocomplete="off" class="post-job">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">Job Title</label>
                                    <input type="text" name="job_title" placeholder="Job title" value="{{$job->job_title}}" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="job_type" id="" class="form-control js-example-theme-single">
                                        ...
                                        @foreach($employmenttypes as $type)
                                            <option value="{{$type->id}}" {{$type->id == $job->job_type_id ? 'selected' : ''}}>{{$type->status ?? ''}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="location" id="" class="form-control js-example-theme-single">
                                        ...
                                        @foreach($states as $state)
                                            <option value="{{$state->id}}" {{$state->id == $job->location_id ? 'selected' : '' }}>{{$state->state_name ?? ''}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="department" id="department" class="form-control js-example-theme-single">
                                        ...
                                        @foreach($departments as $department)
                                            <option value="{{$department->id}}" {{$department->id == $job->department_id ? 'selected' : '' }}>{{$department->department_name ?? ''}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{$job->salary ?? 0 }}" step="0.01" placeholder="Expected salary (optional)" name="salary" class="form-control">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="job_details" placeholder="Type job details like responsibility, skills, experience, etc here..." class="content">{{$job->job_details}}</textarea>
