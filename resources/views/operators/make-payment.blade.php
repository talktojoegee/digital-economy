...
@section('main-content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-xl-6 col-sm-12 col-md-6 offset-lg-3 offset-xl-3 offset-md-3">
            ...
            <div class="card">
                <div class="card-header  text-white bg-primary text-uppercase"> Make Payment <span class="float-right"></span> </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Company Name" value="{{$transaction->getCompany->company_name}}" readonly name="firstName" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="">CEO Name</label>
                                            <input type="text" placeholder="CEO Name" readonly value="{{$transaction->getCompany->ceo_name ?? 'CEO Name'}}" name="lastName" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="">Email Address</label>
                                            <input type="text" placeholder="Email Address" value="{{$transaction->getCompany->email}}" readonly name="email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
