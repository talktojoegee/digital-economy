...
@section('title')
    All Radio License Applications
@endsection
        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Radio License Applications</h4>
                    <div class="btn-group">
                        <a href="{{route('new-radio-license-application')}}" class="btn btn-sm btn-primary float-right"> <i class="ti-plus mr-2"></i> Start New Application</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <table id="example3" class="display table-responsive-lg">
                            ...
                            @foreach($applications as $app)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('view-radio-license-application', $app->slug)}}" class="btn btn-primary shadow btn-xs sharp mr-1 "><i class="ti-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
