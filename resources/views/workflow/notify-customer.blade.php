        ...
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Notify Customer(s)</h4>
                </div>
                <div class="card-body">
                    <p>Notify customer of radio licence expiration.</p>
                    <div class="row mb-3">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{route('notify-customer')}}" method="post">
                                @csrf
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="">To <sup class="text-danger">*</sup></label>
                                        <select name="customer[]" id="" class="form-control  js-example-theme-single" multiple>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" name="subject" placeholder="Subject" value="Courtesy Reminder - Radio Licence">
                                        @error('subject')
                                        <i class="text-danger mt-2">{{$message}}</i>
                                        @enderror
                                    </div>
