                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class=""><strong class="text-danger">Note:</strong> Minimum number of units  <code>5000</code> units</span>
        ...
        $(document).ready(function(){
            $(document).on('blur', '#units', function(e){
                ...
                if(parseInt($(this).val()) < 5000){
                    alert("The minimum amount of units that can be bought is 5000 units");
                    $('#units').val(5000);
                }
