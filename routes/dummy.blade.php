                                    ...
                                    <div class="container">
                                        <div class="row mb-3">
                                            <div class="col-md-12 d-flex justify-content-end">
                                                <a href="javascript:void(0);"><i class="ti-trash text-danger remove-line" style="cursor: pointer;"></i> Remove Item</a>
                                            </div>
                                            <div class="col-md-8">
                                                <h4>Device</h4>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="modeOfOperation" id="modeOfOperation" class="form-control js-example-theme-single select-device-type">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="frequencyBand" id="frequencyBand" class="form-control js-example-theme-single select-device-type">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table card-table table-vcenter text-nowrap mb-0 invoice-detail-table">
                                                ...
                                                <tr class="item">
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <select name="modeOfOperation" id="modeOfOperation" class="form-control">
                                                                <option value="1">Simplex</option>
                                                                <option value="2">Duplex</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <select name="frequencyBand" id="frequencyBand" class="form-control">
                                                                <option value="1">MF/HF</option>
                                                                <option value="2">VHF</option>
                                                                <option value="3">UHF</option>
                                                                <option value="4">SHF</option>
